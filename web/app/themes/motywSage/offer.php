<section class="oferta">
  ...
  <div class="wrapper other-projects">
    ...
    <div>
      <?php if (!empty($prevID)) { ?>
        <a href="<?php the_permalink($prevID)?>"><div class="prev"><i class="fa fa-chevron-left" aria-hidden="true"></i></div></a>
      <?php }?>

      <a href="<?php the_permalink($post->post_parent)?>"><div class="all"><i class="fa fa-th" aria-hidden="true"></i></div></a>

      <?php if (!empty($nextID)) { ?>         
        <a href="<?php the_permalink($nextID)?>"><div class="next"><i class="fa fa-chevron-right" aria-hidden="true"></i></div></a>
      <?php }?>
    </div>
  </div>
</section>