    ...
    <footer class="content-info">
      <div class="container">
        <div class="wrapper">
          ...
          <div class="copyright">Copyright © 2017 <strong>MS-Hydro s.c.</strong> All Rights Reserved </br> Design &amp; code by <a href="http://kraftweb.pl" title="Kraftweb">Kraftweb</a></div>
        </div>
      </div>
    </footer>
